...
```{r boxplots, fig.width=10, fig.height=8, fig.align='center', out.width="90%", include=TRUE}
...
```{r heatmap, fig.width=12, fig.height=8, fig.align='center', out.width="90%", include=TRUE}
