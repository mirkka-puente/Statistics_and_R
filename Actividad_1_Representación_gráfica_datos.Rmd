...
# Instalación
pack_list <- c("BiocManager", "ComplexHeatmap", "circlize", "ggplot2", "dplyr", "patchwork")
...
tumor <- HeatmapAnnotation(Extension_tumor = tipo_tumor,
  col = list(Extension_tumor = c("localizado" = "#FFE7BA", "metastasico" = "#C1FFC1")))
